function registration(){
    ...
    if(name === ""){
      ...
      document.querySelector('#erroremail').innerHTML = "please valid email";
      let selectname = document.querySelector('#email');
      selectname.style.borderColor = "red"
      selectname.style.outlineColor = "red"
      return false;
      ...
      document.querySelector('#errormobile').innerHTML = "mobile number should be only integer";
      let selectname = document.querySelector('#mobile');
      selectname.style.borderColor = "red"
      selectname.style.outlineColor = "red"
      return false;
      ...
      document.querySelector('#errormobile').innerHTML = "please enter your password ";
...
function s(arg){
    ...
    let selectederrordiv = document.querySelector(`#email${arg}`);
